...
const AIEngine = {
  ...
  aiFleet: [
    { shipType: 'Carrier', size: 5, positions: [{posRow: 0, posCol: 0}, {posRow: 0, posCol: 1}, {posRow: 0, posCol: 2}, {posRow: 0, posCol: 3}, {posRow: 0, posCol: 4}] },
    { shipType: 'Battleship', size: 4, positions: [{posRow: 2, posCol: 0}, {posRow: 2, posCol: 1}, {posRow: 2, posCol: 2}, {posRow: 2, posCol: 3}] },
    { shipType: 'Cruiser', size: 3, positions: [{posRow: 4, posCol: 0}, {posRow: 4, posCol: 1}, {posRow: 4, posCol: 2}] },
    { shipType: 'Submarine', size: 3, positions: [{posRow: 6, posCol: 0}, {posRow: 6, posCol: 1}, {posRow: 6, posCol: 2}] },
    { shipType: 'Destroyer', size: 2, positions: [{posRow: 8, posCol: 0}, {posRow: 8, posCol: 1}] }
  ],
